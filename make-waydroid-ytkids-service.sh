...
RUNTIME_SHELL_PATH="/usr/local/bin/waydroid-ytkids.sh"
...
while true; do
    ...
    # Process "surfaceflinger" is found, but "ps.youtube.kids" is not found
        ...
        # Your subshell commands here (for when "surfaceflinger" is found, but "ps.youtube.kids" is not found)
...
sudo chmod 0755 /usr/local/bin/waydroid-ytkids.sh

# Create the service file
cat << EOF > "$SERVICE_PATH"
[Unit]
Description=Waydroid Ytkids Service
